  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [
          _buildOrdersList(userId, true, isDark, textColor),
          _buildOrdersList(userId, false, isDark, textColor),
        ],
      ),
    );
  }
      ...
      builder: (context, snapshot) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, index) {
            return isActive
                ? _buildActiveCard(orders[index], isDark, textColor)
                : _buildHistoryCard(orders[index], isDark, textColor);
          },
        );
      },
    );
